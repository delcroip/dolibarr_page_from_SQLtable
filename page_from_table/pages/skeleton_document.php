...
dol_include_once('/mymodule/class/Skeleton.class.php');
dol_include_once('/mymodule/lib/Skeleton.lib.php');
...
if ($object->id)
{
	...
	dol_fiche_head($head, 'document', $langs->trans("MyObject"), -1, 'Skeleton@mymodule');
