	...
	if ($prop['showfield']==true)
	{
                ...
                if ($prop['istime']){
                ...
                }else if(strpos($prop['field'],'fk_user') ===0) 
                 {
                        ...
                        $varprop.="\t\t}else{\n";
                        $varprop.="\t\tprint print_generic('user', 'rowid',\$object->".$prop['var'].",'lastname','firstname',' ');\n";
...
foreach($property as $key => $prop)
{
    if($prop['showfield']==true) 
    {
        ...
        }else if(strpos($prop['field'],'fk_user') ===0) {//FIXME select user instead
            $varprop.="\t\tprint select_generic('user','rowid','";
            $varprop.= "ls_".$prop['var']."','lastname','firstname',";                
